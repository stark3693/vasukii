...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    // Coordinates for Madhya Pradesh, India
    const mpCoordinates = [78.6569, 22.9734];
    
    map.current = new mapboxgl.Map({
      container: mapContainer.current,
      style: 'mapbox://styles/mapbox/streets-v11',
      center: [mpCoordinates[0], mpCoordinates[1]] as [number, number],
      zoom: 5
    });

    // Add marker
    new mapboxgl.Marker()
      .setLngLat(mpCoordinates as [number, number])
      .addTo(map.current);
